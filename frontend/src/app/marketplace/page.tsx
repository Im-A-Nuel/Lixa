        ...
        {!totalAssets || totalAssets === BigInt(0) ? (
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden hover:border-gray-700 transition">
              ...
              <div className="p-4">
                <h3 className="font-semibold mb-1">Asset #{totalAssets?.toString()}</h3>
                <p className="text-sm text-gray-400 mb-3">5% royalty</p>
                <div className="flex gap-2">
                  <span className="px-2 py-1 bg-purple-600/20 text-purple-400 text-xs rounded">Commercial</span>
                  <span className="px-2 py-1 bg-blue-600/20 text-blue-400 text-xs rounded">Fractionalized</span>
                </div>
              </div>
            </div>
          </div>
